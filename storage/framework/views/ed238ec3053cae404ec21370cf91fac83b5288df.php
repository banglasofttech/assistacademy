...
<div class="content">
    <div class="courses item-section">
        <div class="container">
                ...
                <?php if(count($videos)): ?>
                  <?php $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-lg-3 course_col">
                        <div class="course"><a href="<?php echo e(asset('videos/view/'.$video->id)); ?>">
                            <div class="course_image">
                                <img src="<?php echo e(asset('/storage/thumbnail/videos/'.$video->thumbnail)); ?>" alt="">
                                </div>
                            <div class="course_body">
                                <h4 class="course_title"><?php echo e($video->file_name); ?></h4>
                                <div class="course_teacher"><?php echo e($video->author); ?></div>
                            </div>
                        </a></div>
                    </div>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="pagination"><?php echo e($videos->render()); ?></div>
        </div>
    </div>
</div>
