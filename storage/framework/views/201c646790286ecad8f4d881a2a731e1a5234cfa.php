                ...
                <div class="sidebar_latest">
                  <?php if($file_ext=='mp4'): ?>
                    ...
                    <?php elseif($file_ext=='pdf'): ?>
                        <iframe class="pdf_viewer" src="http://docs.google.com/gview?embedded=true&url=<?php echo e(asset('/storage/files/course/introduction_files/'.$course->introduction_file)); ?>" width="100%" style="height:250px;" frameborder="0">
                        </iframe> 
                    <?php elseif($file_ext=='ppt'): ?>
                        <iframe class="ppt_viewer" src="https://view.officeapps.live.com/op/embed.aspx?src=<?php echo e(asset('/storage/files/courses/introduction_files/'.$course->introduction_file)); ?>" width="100%" style="height:250px;" frameborder="0">
                        </iframe>
                    <?php endif; ?>

                    <a class="btn btn-success btn-block" href="<?php echo e(asset('courses/view/'.$course->id )); ?>" style="font-size: 20px; font-weight: bold; margin-top: 5px;">Get it Now</a>
                </div>
              </div>
