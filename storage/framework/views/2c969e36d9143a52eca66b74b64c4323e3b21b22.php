                ...
                <?php if(count($trainings)): ?>
                  <?php $__currentLoopData = $trainings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $training): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-lg-3 course_col">
                        <div class="course"><a href="<?php echo e(asset('training/view/'.$training->id)); ?>">
                            ...
                            <div class="course_body">
                                ...
                                <div class="d-flex">
                                    <div class="mr-auto p-2 course_teacher"><?php echo e($training->author); ?></div>
                                    <div class="p-2 course_price">
                                          <?php if($training->course_fee>0): ?>
                                              $<?php echo e($training->course_fee); ?>  
                                          <?php else: ?>
                                              Free
                                          <?php endif; ?>
                                      </div>
