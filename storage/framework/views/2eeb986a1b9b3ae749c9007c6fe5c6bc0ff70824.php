...
<?php $__env->startSection('content_title', "Edit Book"); ?>

<?php $__env->startSection('content'); ?>
    <div class="col-md-9">
        <form class="panel-body" method="POST" action="<?php echo e(route('editBook')); ?>" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="File Name" id="file_name" name="file_name" required autofocus value="<?php echo e($book->file_name); ?>" />
            </div>
