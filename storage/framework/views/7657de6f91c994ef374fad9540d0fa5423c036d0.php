      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          <div class="course_container">
            <div class="course_title"><?php echo e($ppt->file_name); ?></div>
            <div class="course_info d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-start">

              <!-- Course Info Item -->
              <div class="course_info_item">
                <div class="course_info_title">Author:</div>
                <div class="course_info_text"><a href="<?php echo e(asset('ppts/author/'.$ppt->uploader_email)); ?>"><?php echo e($author->first_name); ?> <?php echo e($author->last_name); ?></a></div>
              </div>
                ...
                <div class="sidebar_teacher">
                  <div class="teacher_title_container d-flex flex-row align-items-center justify-content-start">
                    ...
                    <div class="teacher_title">
                      <div class="teacher_name"><a href="<?php echo e(asset('ppts/author/'.$ppt->uploader_email)); ?>"><?php echo e($author->first_name); ?> <?php echo e($author->last_name); ?></a></div>
