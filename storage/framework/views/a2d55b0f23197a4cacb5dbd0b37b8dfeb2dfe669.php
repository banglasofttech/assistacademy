...
<?php $__env->startSection('title', $title." - Books"); ?>
...
<div class="">
  ...
  <div class="item-panel bg-warning d-flex">
    <div class="mr-auto p-2">
      <font style="font-size: 25px; text-transform: uppercase;"><?php echo e($title); ?> <sub class="text-capitalize">(Books)</sub></font>
    </div>
    <div class="p-2 align-middle">
      <form method="POST"  class=" " action="<?php echo e(route('search')); ?>" enctype="multipart/form-data">
          <?php echo e(csrf_field()); ?>

          <input type="hidden" name="file_type" value="book">
          <input  type="name" class="flipkart-navbar-input" placeholder="Search Books" id="file_name" name="file_name">
  ...
  <?php else: ?>
  <h2 class="text-center">Sorry, no book found</h2>
  <?php endif; ?>
</div>
