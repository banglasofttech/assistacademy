<?php $__env->startSection('title', "Edit PPT"); ?>

<?php $__env->startSection('content_title', "Edit PPT"); ?>

<?php $__env->startSection('content'); ?>
    <div class="col-md-9">
        <form class="panel-body" method="POST" action="<?php echo e(route('editPPT')); ?>" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="File Name" id="file_name" name="file_name" required autofocus value="<?php echo e($ppt->file_name); ?>" />
            </div>

            <div class="form-group">
                <label>Select New PPT File (<span id="file_format" style="color: gray;">If you want to remove old file</span>)</label>
            ...
            <input type="hidden" name="id"  value="<?php echo e($ppt->id); ?>" />
