...
<?php $__env->startSection('content_title', "Manage Videos"); ?>
        ...
        <tbody>
          ...
          ?>
            <tr>
              ...
              <td>
                <a href="/managefiles/videos/edit/<?php echo e($video->id); ?>" class="btn btn-success btn-sm">Edit</a>
                <a href="/managefiles/videos/remove/<?php echo e($video->id); ?>" class="btn btn-danger btn-sm">Remove</a>
              </td>
            </tr>
