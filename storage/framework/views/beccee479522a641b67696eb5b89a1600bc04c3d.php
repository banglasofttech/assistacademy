        ...
        <form class="panel-body" method="POST" action="<?php echo e(route('upload')); ?>" enctype="multipart/form-data">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              ...
              <select class="form-control" name="file_catagory" id="file_catagory" required autofocus style="width: 200px; height: 33px;">
             ...
             <div class="form-group" id="sub_catagory" style="display: none;">
              ...
              <select class="form-control" name="file_sub_catagory" id="file_sub_catagory" style="width: 200px; height: 33px;" >
                  ...
                  <?php $__currentLoopData = $subcatagories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcatagory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($subcatagory->id); ?>"><?php echo e($subcatagory->catagory_name); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
