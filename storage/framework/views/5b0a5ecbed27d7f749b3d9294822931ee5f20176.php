...
<body>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <?php if(Auth::user()->user_type=="admin"): ?>
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="<?php echo e(asset('bookrequest')); ?>">Book Request</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(asset('videorequest')); ?>">Video Request</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(asset('pptrequest')); ?>">PPT Request</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(asset('trainingrequest')); ?>">Training Request</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(asset('courserequest')); ?>">Course Request</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li>
                                <a href="<?php echo e(asset('remove-category')); ?>"><i class="fa fa-trash"></i> Remove Category</a>
                            </li>
                        <?php endif; ?>
                    </ul>
                </div>
    ...
    <script src="<?php echo e(asset('content/js/editCourse.js')); ?>"></script>
