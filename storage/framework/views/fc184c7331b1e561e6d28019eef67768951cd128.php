        ...
        <tbody>
          ...
          ?>
            <tr>
              ...
              <td>
                <a href="/managefiles/books/edit/<?php echo e($book->id); ?>" class="btn btn-success btn-sm">Edit</a>
                <a href="/managefiles/books/remove/<?php echo e($book->id); ?>" class="btn btn-danger btn-sm">Remove</a>
              </td>
            </tr>
