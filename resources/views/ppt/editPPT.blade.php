...
@section('title', "Edit PPT")

@section('content_title', "Edit PPT")

@section('content')
    <div class="col-md-9">
        <form class="panel-body" method="POST" action="{{ route('editPPT') }}" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="File Name" id="file_name" name="file_name" required autofocus value="{{ $ppt->file_name }}" />
            </div>
