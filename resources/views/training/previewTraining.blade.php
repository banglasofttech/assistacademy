              ...
              <div class="sidebar_section">
                ...
                <div class="sidebar_latest">
                  @if($file_ext=='mp4')
                    ...
                    @elseif($file_ext=='pdf')
                        <iframe class="pdf_viewer" src="http://docs.google.com/gview?embedded=true&url={{asset('/storage/files/training/introduction_files/'.$training->introduction_file)}}" width="100%" style="height:250px;" frameborder="0">
                        </iframe> 
                    @elseif($file_ext=='ppt')
                        <iframe class="ppt_viewer" src="https://view.officeapps.live.com/op/embed.aspx?src={{asset('/storage/files/training/introduction_files/'.$training->introduction_file)}}" width="100%" style="height:250px;" frameborder="0">
                        </iframe>
                    @endif

                    <a class="btn btn-success btn-block" href="{{asset('training/view/'.$training->id )}}" style="font-size: 20px; font-weight: bold;margin-top: 5px;">Get it Now</a>
                </div>
              </div>
